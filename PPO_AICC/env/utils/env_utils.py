...
def make_env(scenario: str, index: int, env_index: int, config: Config):# 不用改
    def _thunk():
        return ns3.ns3(scenario, index, env_index, config)
...
class DummyVecEnvWithResetInfo(VecEnv):
    ...
    def __init__(self, env_fns):
        self.envs = [fn() for fn in env_fns] #output a list of omnetpp/ns3 obj
