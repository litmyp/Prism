...
def parse_args():
    ...
    parser.add_argument('--config', default='adpg', help='Name of the config file to be loaded')
    ...
    parser.add_argument('--distill', action='store_true', default=-1, help='Use distilled decision tree model for evaluation')
    parser.add_argument('--distill_model', default=-1, type=str_parser, help='Path to distilled model (.cbm)')
    parser.add_argument('--distill_output_type', default=-1, type=str, choices=['discrete', 'continuous'], help='Output type of distilled model')
    parser.add_argument('--lut', action='store_true', default=-1, help='Use LUT table for evaluation')
    parser.add_argument('--lut_path', default=-1, type=str_parser, help='Path to LUT npz file')
